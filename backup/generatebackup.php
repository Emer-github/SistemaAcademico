...
<div id="load_img">
<img class="img-responsive"  style="height:225px;" src="../img/logo.jpg" class="img-circle" alt="User Image">
</div>

<p align="center" class="text-muted mail-text">CENTRO ESCOLAR CATÓLICO</p>
<p align="center" class="text-muted mail-text">NUESTRA SEÑORA DE LOS POBRES</p>
</div> 
</div>
...
if ($rowcount) {
  //conexion a db
	$con = mysqli_connect("localhost","root","","bd_registro_academico");
...
$date = date('d-m-Y'); 
$filename = $folder."CECE_POBRES_".$date; 
