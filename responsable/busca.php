...
// Consulta de la paginación
      $sql = "SELECT *, DATE_FORMAT(nacimiento, '%d/%m/%Y') AS fechaNacimiento FROM $Table $Where ORDER BY dui desc LIMIT $offset,$per_page";
...
foreach($model as $row){ //Mostrar los datos encontrados en la BD $model, $row tomados lineas atras.
  ?>
     ...
     ?>
      ...
      <input type="hidden" value="<?php echo $row['nacimiento'];?>" id="nacimiento<?php echo $row['dui'];?>">
      <input type="hidden" value="<?php echo $row['estadoCivil'];?>" id="estadoCivil<?php echo $row['dui'];?>">
      <input type="hidden" value="<?php echo $row['profesion'];?>" id="profesion<?php echo $row['dui'];?>">
      <input type="hidden" value="<?php echo $row['ultimoGrado'];?>" id="ultimoGrado<?php echo $row['dui'];?>">
      <input type="hidden" value="<?php echo $row['telefono'];?>" id="telefono<?php echo $row['dui'];?>"> 
      <input type="hidden" value="<?php echo $row['zona'];?>" id="zona<?php echo $row['dui'];?>">
