...
<input type="text" class="form-control" onkeypress="return soloLetras(event);" title="Ingresar más de 3 letras" placeholder="Ingresar nombres de la madre de familia." pattern=".{3,44}" name="mod_nombres" id="mod_nombres" required="">
...
<div class="col-sm-9">
<!-- Evento solo minusculas-->
<input type="text" class="form-control" onkeypress="return soloLetras(event);" pattern=".{3,44}" placeholder="Ingresar apellidos de la madre de familia." title="Ingresar más de 3 letras" name="mod_apellidos" id="mod_apellidos" required="">
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<!-- Evento solo minusculas-->
<input type="text" class="form-control" onkeypress="return soloLetras(event);" title="Ingresar más de 3 letras" placeholder="Ingresar el número de DUI." pattern=".{5,44}" name="mod_profesion" id="mod_profesion" required="">
