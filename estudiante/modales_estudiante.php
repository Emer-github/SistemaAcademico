...
<div class="form-group">
<label for="bussines_name" class="col-sm-3 control-label">Nacionalidad:</label>
<div class="col-sm-9">
<select class="form-control" name="mod_nacionalidad" id="mod_nacionalidad" required="">
  <option disabled="" selected=""></option>
...
<div class="form-group">
<label for="bussines_name" class="col-sm-3 control-label">Enfermedades:</label>
<div class="col-sm-9">
<input type="text" class="form-control" title="Ingresar más de 20 letras" placeholder="Ingresar enfermedades (si tuviera)" pattern=".{0,200}" name="mod_enfermedad" id="mod_enfermedad">
</div>
</div>
<div class="form-group">
<label for="bussines_name" class="col-sm-3 control-label">Alérgico a:</label>
<div class="col-sm-9">
<input type="text" class="form-control" title="Ingresar más de 20 letras" placeholder="Ingresar alergía (si tuviera)" pattern=".{0,200}" name="mod_alergia" id="mod_alergia">
</div>
</div>
