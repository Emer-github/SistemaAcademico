...
<!DOCTYPE html>
   ...
   <div class="form-panel">
    ...
    <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="mostrar.php" data-toggle="tab">Currículum</a></li>
                        </ul>
                </div>
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="Activos">
    <center><h3> Listado de Currículums</h3></center>
    <div class=' pull-right'>
      <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal_curriculum">
        <i class="fa fa-upload" ></i>&nbsp;&nbsp;<span class="tooltips" data-placement="left" data-original-title="Registrar nuevo Currículum">Agregar</span>
    </button>
    </div>
    <div id="loader" class="text-center">
      ...
      <form class="form-horizontal">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="q" placeholder="Buscar Currículum" onkeyup="load(1)" autocomplete="off">
            </div>
  ...
  <!-- Latest compiled and minified JavaScript -->
    ...
    <?php
       include("busca.php"); 
      include("modales_curriculum.php");
    ?> 
    </div>
</div>
  <?php
