...
foreach($model as $row)
...

    {
      ...
      $html .='<tr><td>'.$row["idbanquete"].'</td>';
      
        $html.='<td>'.$row['fechabanquete'].'</td>';
...
$html .='</tr><tr><td align="right" colspan="4"><b>Total:</b></td><td colspan="" style="background-color:#aae599;"><b>'.number_format($totalp,2).'</b></td> <td colspan="3"></td></tr>';
...
$mpdf->SetTitle("Reporte Banquete");
...
$mpdf->Output('Reporte Banquete  '.$fecha.'.pdf','I');
