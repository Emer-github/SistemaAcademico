...
<!DOCTYPE html>
  ...
  <?php
   ...
   <div class="form-panel">
    ...
    <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="index.php" data-toggle="tab">Comentarios</a></li>
                        </ul>
                </div>
    ...
    <center><h3> Listado de comentarios</h3></center>
    <div class=' pull-right'>
      <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal_register">
    ...
    <div id="loader" class="text-center">
      ...
      <form class="form-horizontal">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="q" placeholder="Buscar comentario por: comentario, fecha(año-mes-día)." onkeyup="load(1)">
            </div>
  ...
  <!-- Latest compiled and minified JavaScript -->
    ...
    <?php
       include("busca.php"); 
       include("modales_comentario.php"); 
    ?> 
    </div>
</div>
  <?php
