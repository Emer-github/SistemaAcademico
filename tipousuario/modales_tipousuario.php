...
<!-- Modal para dar permisos -->
<form class="form-horizontal" action="permiso.php" method="POST"  accept-charset="utf-8"   autocomplete="off" role="form">
...
<div class="form-group"><br>
    ...
    <div class="form-check">
    	 <input type="checkbox" class="form-check-label" placeholder="Seleccione para dar permiso" name="mod_presupuesto" id="mod_presupuesto">
        <label class="form-check-label" for="gridCheck9">
          Presupuesto
        </label>
    </div>
    <div class="form-check">
    	 <input type="checkbox" class="form-check-label" placeholder="Seleccione para dar permiso" name="mod_inventario" id="mod_inventario">
