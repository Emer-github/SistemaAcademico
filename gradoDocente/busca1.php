...
foreach($model as $row){ //Mostrar los datos encontrados en la BD $model, $row tomados lineas atras.
  ?>
     <tr style="text-align: center;">
      ...
      <td>
        <?php
          ...
          echo "<tr align='center' class='danger'><th style='text-align: center;'>Asignatura</th><th style='text-align: center;'>Docente</th><th style='text-align: center;'>Ver</th></tr>";
    ...
    echo "<td align='center' width='10%'  class='active'><a class='btn btn-primary btn-xs;' data-toggle='modal' data-target='#modal_update' onclick='editar(".$row['idgradoDocente'].");''><i style='color:white;' class='fa fa-edit'></a></i></td>";
      ...
      //echo "<td align='center' width='10%' class='active'><button class='btn btn-success btn-xs;' data-toggle='modal' data-target='#modal_verde' onclick='activar(".$row['idgradoDocente'].");''><i class='fa fa-check-circle'></i></button></td>";
  ?>
      </tr>
      <!-- envio de datos-->
