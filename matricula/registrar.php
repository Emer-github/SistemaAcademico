<?php
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $consult = $conn->prepare("SELECT grado_docente.*,grado.nombre as nombreGrado FROM grado_docente inner join grado on grado_docente.idgrado=grado.idgrado where grado_docente.idgradoDocente='$idgrado'");
      $consult->execute();
...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="#"><i class="fa fa-graduation-cap"></i> <?php echo "Matrícula ".$nombreGrado." Grado"; ?></a>
        </div>
