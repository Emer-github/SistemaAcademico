...
foreach($model as $row){ //Mostrar los datos encontrados en la BD $model, $row tomados lineas atras.
  ?>
      ...
      <?php 
      echo "<td align='center' width='10%' class='active'><a class='btn btn-success btn-xs;' data-toggle='modal' data-target='#modal_matricula' onclick='matricula(".$row['idgradoDocente'].");''><i style='color:white;' class='fa fa-list'></a></i></td>";
      echo "<td align='center' width='10%' class='active'><a class='btn btn-primary btn-xs;' data-toggle='modal' data-target='#modal_calificaciones' onclick='calificar(".$row['idgradoDocente'].");''><i style='color:white;' class='fa fa-edit'></a></i></td>";
      echo "<td align='center' width='10%' class='active'><a class='btn btn-warning btn-xs;' data-toggle='modal' data-target='#modal_ver' onclick='ver(".$row['idgradoDocente'].");''><i style='color:white;' class='fa fa-eye'></a></i></td>";
     ?>
      </tr>
      <!-- envio de datos-->
